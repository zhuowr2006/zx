...
public class PreferencesUtils {
	...
	public static String PREFERENCE_NAME = AppConfig.APP_PREFERENCE_NAME;
	...
	public static void putUserData(Context context, UserBean userBean) {
		PreferencesUtils.putString(context, AppConfig.USER_NAME, userBean.getName());
		PreferencesUtils.putString(context, AppConfig.USER_ID, userBean.getCredNum());
		PreferencesUtils.putString(context, AppConfig.USER_ID_TYPE, userBean.getCertType());
		PreferencesUtils.putString(context, AppConfig.USER_PHONE, userBean.getMobileNum());
	}
	...
	public static void clearUserData(Context context) {
		// 清除本地数据
		PreferencesUtils.putString(context, AppConfig.USER_NAME, "");
		PreferencesUtils.putString(context, AppConfig.USER_ID, "");
		PreferencesUtils.putString(context, AppConfig.USER_ID_TYPE, "");
		PreferencesUtils.putString(context, AppConfig.USER_PHONE, "");
	}
}
